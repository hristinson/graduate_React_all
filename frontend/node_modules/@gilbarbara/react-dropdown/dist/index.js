...
function Clear(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledClear, {
    "aria-label": clear,
    ...
    title: clear,
    ...getStyles2(),
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Times_default, {})
  });
}
...
function Option(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StyledOption, {
...
function Content(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledContent, {
    className: `${SLUG}-content ${multi ? `${SLUG}-type-multi` : `${SLUG}-type-single`}`,
    onClick: handleClick,
    ...getStyles2(),
    children: contentComponent ? contentComponent(props) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [
        multi ? values.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Option, {
          item,
          ...props
        }, `${getOptionData(item, "label")}${getOptionData(item, "value")}`)) : !!values.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledSingleOption, {
          "data-component-name": "DropdownSingleOption",
          ...getStyles2(),
          children: getOptionData(values[0], "label")
        }),
        (!values.length || searchable) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
          ...props
        })
      ]
    })
...
function Handle(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledHandle, {
    "aria-label": toggle,
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      children: handleComponent ? handleComponent(props) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Arrow, {})
    })
  });
}
...
function Loading(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledLoading, {
...
function Create(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledCreate, {
...
function MenuItem(props) {
  ...
  (0, import_react5.useEffect)(() => {
    var _a;
    if (cursor === itemIndex) {
      (_a = ref.current) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "start" });
    }
  }, [cursor, itemIndex]);
  const handleClick = (event) => {
    event.stopPropagation();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StyledMenuItem, {
    ...
    children: [
      ...
      " ",
      disabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ins", {
...
function NoData(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledNoData, {
...
function Menu(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledMenu, {
    ref: listRef,
    ...
    tabIndex: -1,
    ...getStyles2(),
    children: menuComponent ? menuComponent(props) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Create, {
          ...props
        }),
        searchResults.length ? searchResults.map((item, itemIndex) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItem, {
          item,
          itemIndex,
          ...props
        }, item.value)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NoData_default, {
          ...props
        })
      ]
    })
...
function Separator(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StyledSeparator, {
...
var Dropdown = class extends import_react9.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ReactDropdown, {
      ...
      children: [
        ...
        hiddenInput && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
        ...
        showClearButton && !!values.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clear, {
          methods: this.methods,
          props: this.props,
          state: this.state
        }),
        loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loading_default, {
          methods: this.methods,
          props: this.props,
          state: this.state
        }),
        showSeparator && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Separator, {
          methods: this.methods,
          props: this.props,
          state: this.state
        }),
        !hideHandle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Handle, {
          methods: this.methods,
          props: this.props,
          state: this.state
        }),
        status && !disabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu_default, {
          methods: this.methods,
          props: this.props,
          state: this.state
        })
