...
export const Box = forwardRef((props, ref) => {
    ...
    return (_jsx(StyledBox, { ref: ref, "data-component-name": "Box", ...rest, children: children }));
});
Box.defaultProps = {
    flexBox: false,
};
export const BoxCenter = forwardRef((props, ref) => (_jsx(StyledBox, { ref: ref, "data-component-name": "BoxCenter", ...props })));
...
export const BoxInline = forwardRef((props, ref) => (_jsx(StyledBox, { ref: ref, as: "span", "data-component-name": "BoxInline", ...props })));
