...
export const Avatar = forwardRef((props, ref) => {
    ...
    const selectedSize = sizes[size];
    return (_jsx(BoxCenter, { ref: ref, "data-component-name": "Avatar", height: selectedSize.size, overflow: "hidden", radius: "round", width: selectedSize.size, ...rest, children: image ? (_jsx("img", { alt: name, height: selectedSize.size, src: image, width: selectedSize.size })) : (_jsx(Circle, { shade: shade, size: size, variant: variant, children: getInitials(name).toUpperCase() })) }));
});
Avatar.defaultProps = {
    shade: 'mid',
    size: 'md',
