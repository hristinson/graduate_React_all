...
function TooltipBody(props) {
    ...
    return (_jsxs(StyledBody, { align: align, bg: bg, color: color, "data-component-name": "TooltipBody", position: position, size: size, style: style, wrap: wrap, children: [isValidElement(content) ? (content) : (_jsx(StyledContent, { bold: bold, "data-component-name": "TooltipContent", size: size, children: content })), _jsx(StyledArrow, { align: align, bg: bg, color: color, "data-component-name": "TooltipArrow", position: position })] }));
}
export function Tooltip(props) {
    ...
    return (_jsxs(StyledTooltip, { "aria-label": text, "data-component-name": "Tooltip", onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, role: "tooltip", children: [children, isOpen && _jsx(TooltipBody, { ...props, bg: bg, color: color })] }));
}
