...
export const StyledSelect = styled('select', getStyledOptions())(props => {
...
export const Select = forwardRef((props, ref) => {
    ...
    return (_jsx(StyledSelect, { ref: mergeRefs([localRef, ref]), "data-component-name": "Select", filled: isFilled, id: name, ...props, onChange: handleChange }));
});
Select.defaultProps = {
    borderless: false,
    disabled: false,
