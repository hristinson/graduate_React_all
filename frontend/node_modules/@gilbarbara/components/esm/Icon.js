...
export const Icon = forwardRef((props, ref) => {
    ...
    return (_jsx(StyledIcon, { ref: ref, "data-component-name": "Icon", name: name, size: size, ...rest, children: _jsx(SVG, { height: size, src: iconURL, title: titleString, width: size }) }));
});
Icon.defaultProps = {
    size: 16,
    spin: false,
