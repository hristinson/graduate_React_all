...
export declare type FieldTypes = InputTypes | 'checkbox' | 'dropdown' | 'radio' | 'select' | 'toggle' | 'textarea';
export declare type FieldValidations = 'email' | `equalsTo:${string}` | 'password' | 'phoneBR';
export interface FieldInputHandlers<T extends HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement> {
    onBlur?: FocusEventHandler<T>;
    onChange?: ChangeEventHandler<T>;
    onFocus?: FocusEventHandler<T>;
}
export interface FieldBaseProps extends Pick<FormGroupProps, 'assistiveText' | 'hideAssistiveText' | 'inline' | 'label' | 'required' | 'style'> {
    autoComplete?: string;
    clearError?: () => void;
    debug?: boolean;
    disabled?: boolean;
...
export interface FieldTextareaProps extends FieldBaseProps, FieldInputHandlers<HTMLTextAreaElement> {
    children?: never;
    dropdownProps?: never;
    items?: never;
    rows?: number;
...
export declare type FieldProps = FieldCheckboxProps | FieldDropdownProps | FieldInputProps | FieldRadioProps | FieldSelectProps | FieldTextareaProps | FieldToggleProps;
