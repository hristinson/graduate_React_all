...
exports.textSizes = exports.sizes = exports.inputTypes = exports.icons = exports.iconsCustom = exports.iconsPack = void 0;
const helpers_1 = require("@gilbarbara/helpers");
exports.iconsPack = [
    { name: 'alarm', categories: ['devices'] },
    ...
    { name: 'arrow-long-down-c', categories: ['arrows'] },
    { name: 'arrow-long-down-e', categories: ['arrows'] },
    { name: 'arrow-long-down-l', categories: ['arrows'] },
    { name: 'arrow-long-down-r', categories: ['arrows'] },
    { name: 'arrow-long-down', categories: ['arrows'] },
    { name: 'arrow-long-left-c', categories: ['arrows'] },
    { name: 'arrow-long-left-e', categories: ['arrows'] },
    { name: 'arrow-long-left-l', categories: ['arrows'] },
    { name: 'arrow-long-left-r', categories: ['arrows'] },
    { name: 'arrow-long-left', categories: ['arrows'] },
    { name: 'arrow-long-right-c', categories: ['arrows'] },
    { name: 'arrow-long-right-e', categories: ['arrows'] },
    { name: 'arrow-long-right-l', categories: ['arrows'] },
    { name: 'arrow-long-right-r', categories: ['arrows'] },
    { name: 'arrow-long-right', categories: ['arrows'] },
    { name: 'arrow-long-up-c', categories: ['arrows'] },
    { name: 'arrow-long-up-e', categories: ['arrows'] },
    { name: 'arrow-long-up-l', categories: ['arrows'] },
    { name: 'arrow-long-up-r', categories: ['arrows'] },
    { name: 'arrow-long-up', categories: ['arrows'] },
    ...
    { name: 'arrows-breake-h', categories: ['arrows'] },
    { name: 'arrows-breake-v', categories: ['arrows'] },
    ...
    { name: 'arrows-expand-left-alt', categories: ['arrows'] },
    { name: 'arrows-expand-left', categories: ['arrows'] },
    { name: 'arrows-expand-right-alt', categories: ['arrows'] },
    ...
    { name: 'box', categories: ['ui'] },
    { name: 'boy', categories: ['ui'] },
    { name: 'briefcase', categories: ['ui'] },
    { name: 'browse', categories: ['ui'] },
    { name: 'browser', categories: ['ui'] },
    { name: 'brush', categories: ['ui'] },
    { name: 'bulb', categories: ['misc'] },
    ...
    { name: 'data', categories: ['multimedia'] },
    { name: 'database', categories: ['ui'] },
    { name: 'debug', categories: ['development'] },
    ...
    { name: 'format-strike', categories: ['typography'] },
    ...
    { name: 'gender-female', categories: ['ui'] },
    { name: 'gender-male', categories: ['ui'] },
    { name: 'gift', categories: ['misc'] },
    { name: 'girl', categories: ['ui'] },
    { name: 'git-branch', categories: ['development'] },
    { name: 'git-commit', categories: ['development'] },
    { name: 'git-fork', categories: ['development'] },
    { name: 'git-pull', categories: ['development'] },
    { name: 'glass-alt', categories: ['misc'] },
    { name: 'globe-alt', categories: ['ui'] },
    { name: 'globe', categories: ['ui'] },
    { name: 'gym', categories: ['misc'] },
    { name: 'hashtag', categories: ['ui'] },
    { name: 'headset', categories: ['devices', 'multimedia'] },
    { name: 'heart', categories: ['ui'] },
    { name: 'hello', categories: ['misc'] },
    { name: 'home-alt', categories: ['ui'] },
    { name: 'home-screen', categories: ['devices'] },
    { name: 'home', categories: ['ui'] },
    { name: 'icecream', categories: ['misc'] },
    ...
    { name: 'log-in', categories: ['ui'] },
    { name: 'log-off', categories: ['ui'] },
    { name: 'log-out', categories: ['ui'] },
    { name: 'loupe', categories: ['ui'] },
    { name: 'magnet', categories: ['misc'] },
    { name: 'mail-forward', categories: ['ui'] },
    { name: 'mail-open', categories: ['ui'] },
    { name: 'mail-reply', categories: ['ui'] },
    { name: 'mail', categories: ['ui'] },
    { name: 'math-divide', categories: ['ui'] },
    { name: 'math-equal', categories: ['ui'] },
    { name: 'math-minus', categories: ['ui'] },
    { name: 'math-percent', categories: ['ui'] },
    { name: 'math-plus', categories: ['ui'] },
    { name: 'maximize-alt', categories: ['ui'] },
    { name: 'maximize', categories: ['ui'] },
    { name: 'media-live', categories: ['multimedia'] },
    { name: 'media-podcast', categories: ['multimedia'] },
    { name: 'menu-boxed', categories: ['ui'] },
    { name: 'menu-cake', categories: ['ui'] },
    { name: 'menu-cheese', categories: ['ui'] },
    { name: 'menu-grid-o', categories: ['ui'] },
    { name: 'menu-grid-r', categories: ['ui'] },
    { name: 'menu-hotdog', categories: ['ui'] },
    { name: 'menu-left-alt', categories: ['ui'] },
    { name: 'menu-left', categories: ['ui'] },
    { name: 'menu-motion', categories: ['ui'] },
    { name: 'menu-oreos', categories: ['ui'] },
    ...
    { name: 'modem', categories: ['devices'] },
    { name: 'moon', categories: ['misc'] },
    { name: 'more-alt', categories: ['ui'] },
    { name: 'more-r', categories: ['ui'] },
    { name: 'more-vertical-alt', categories: ['ui'] },
    { name: 'more-vertical-r', categories: ['ui'] },
    ...
    { name: 'move-task', categories: ['ui'] },
    { name: 'move-up', categories: ['ui'] },
    { name: 'music', categories: ['multimedia'] },
    { name: 'music-note', categories: ['multimedia'] },
    { name: 'music-speaker', categories: ['multimedia'] },
    { name: 'nametag', categories: ['ui'] },
    { name: 'notes', categories: ['ui'] },
    { name: 'notifications', categories: ['ui'] },
    { name: 'options', categories: ['ui'] },
    { name: 'organisation', categories: ['ui'] },
    ...
    { name: 'pen', categories: ['ui'] },
    { name: 'pentagon-bottom-left', categories: ['misc'] },
    { name: 'pentagon-bottom-right', categories: ['misc'] },
    { name: 'pentagon-down', categories: ['misc'] },
    { name: 'pentagon-left', categories: ['misc'] },
    { name: 'pentagon-right', categories: ['misc'] },
    { name: 'pentagon-top-left', categories: ['misc'] },
    { name: 'pentagon-top-right', categories: ['misc'] },
    { name: 'pentagon-up', categories: ['misc'] },
    { name: 'performance', categories: ['ui'] },
    { name: 'phone', categories: ['devices'] },
    { name: 'photoscan', categories: ['devices'] },
    { name: 'piano', categories: ['multimedia'] },
    { name: 'pill', categories: ['misc'] },
    { name: 'pin-alt', categories: ['ui'] },
    { name: 'pin-bottom', categories: ['ui'] },
    { name: 'pin-top', categories: ['ui'] },
    { name: 'pin', categories: ['ui'] },
    { name: 'play-backwards', categories: ['multimedia'] },
    { name: 'play-button-o', categories: ['multimedia', 'circle'] },
    { name: 'play-button-r', categories: ['multimedia', 'square'] },
    { name: 'play-button', categories: ['multimedia'] },
    { name: 'play-forwards', categories: ['multimedia'] },
    { name: 'play-list-add', categories: ['multimedia'] },
    { name: 'play-list-check', categories: ['multimedia'] },
    { name: 'play-list-remove', categories: ['multimedia'] },
    { name: 'play-list-search', categories: ['multimedia'] },
    { name: 'play-list', categories: ['multimedia'] },
    { name: 'play-pause-o', categories: ['multimedia', 'circle'] },
    { name: 'play-pause-r', categories: ['multimedia', 'square'] },
    { name: 'play-pause', categories: ['multimedia'] },
    { name: 'play-stop-o', categories: ['multimedia', 'circle'] },
    { name: 'play-stop-r', categories: ['multimedia', 'square'] },
    { name: 'play-stop', categories: ['multimedia'] },
    { name: 'play-track-next-o', categories: ['multimedia', 'circle'] },
    { name: 'play-track-next-r', categories: ['multimedia', 'square'] },
    { name: 'play-track-next', categories: ['multimedia'] },
    { name: 'play-track-prev-o', categories: ['multimedia', 'circle'] },
    { name: 'play-track-prev-r', categories: ['multimedia', 'square'] },
    { name: 'play-track-prev', categories: ['multimedia'] },
    { name: 'plug', categories: ['ui'] },
    { name: 'pokemon', categories: ['misc'] },
    { name: 'polaroid', categories: ['misc'] },
    { name: 'poll', categories: ['ui'] },
    { name: 'presentation', categories: ['ui'] },
    ...
    { name: 'server', categories: ['ui'] },
    { name: 'shape-circle', categories: ['misc'] },
    { name: 'shape-half-circle', categories: ['misc'] },
    { name: 'shape-hexagon', categories: ['misc'] },
    { name: 'shape-rhombus', categories: ['misc'] },
    { name: 'shape-square', categories: ['misc'] },
    { name: 'shape-triangle', categories: ['misc'] },
    { name: 'shape-zigzag', categories: ['misc'] },
    { name: 'share', categories: ['ui'] },
    { name: 'shield', categories: ['misc'] },
    { name: 'shopping-bag', categories: ['ui'] },
    { name: 'shopping-cart', categories: ['ui'] },
    { name: 'shortcut', categories: ['ui'] },
    ...
    { name: 'sketch', categories: ['misc'] },
    { name: 'sleep', categories: ['ui'] },
    { name: 'smart-home-boiler', categories: ['misc'] },
    { name: 'smart-home-cooker', categories: ['misc'] },
    { name: 'smart-home-heat', categories: ['misc'] },
    { name: 'smart-home-light', categories: ['misc'] },
    { name: 'smart-home-refrigerator', categories: ['misc'] },
    { name: 'smart-home-wash-machine', categories: ['misc'] },
    { name: 'smartphone', categories: ['devices'] },
    { name: 'smartphone-chip', categories: ['devices'] },
    { name: 'smartphone-ram', categories: ['devices'] },
    { name: 'smartphone-shake', categories: ['devices'] },
    { name: 'smile-mouth-open', categories: ['ui'] },
    { name: 'smile-neutral', categories: ['ui'] },
    { name: 'smile-no-mouth', categories: ['ui'] },
    { name: 'smile-none', categories: ['ui'] },
    { name: 'smile-sad', categories: ['ui'] },
    { name: 'smile-upside', categories: ['ui'] },
    { name: 'smile', categories: ['ui'] },
    { name: 'software-download', categories: ['ui'] },
    { name: 'software-upload', categories: ['ui'] },
    ...
    { name: 'stopwatch', categories: ['devices'] },
    { name: 'stories', categories: ['ui'] },
    { name: 'style', categories: ['ui'] },
    { name: 'sun', categories: ['ui'] },
    { name: 'support', categories: ['ui'] },
    { name: 'swap-vertical', categories: ['ui'] },
    { name: 'swap', categories: ['ui'] },
    { name: 'sync', categories: ['ui'] },
    { name: 'tab', categories: ['ui'] },
    { name: 'tap-double', categories: ['ui'] },
    { name: 'tap-single', categories: ['ui'] },
    { name: 'template', categories: ['ui'] },
    { name: 'tennis', categories: ['misc'] },
    { name: 'terminal', categories: ['development'] },
    { name: 'terrain', categories: ['misc'] },
    { name: 'thermometer', categories: ['misc'] },
    { name: 'thermostat', categories: ['misc'] },
    { name: 'tikcode', categories: ['misc'] },
    { name: 'time', categories: ['ui'] },
    { name: 'timelapse', categories: ['ui'] },
    { name: 'timer', categories: ['ui'] },
...
exports.iconsCustom = [
    { name: 'accessibility', categories: ['ui', 'circle'] },
    { name: 'add', categories: ['ui', 'circle'] },
    { name: 'add-r', categories: ['ui', 'square'] },
    ...
    { name: 'block', categories: ['ui', 'circle'] },
    ...
    { name: 'danger', categories: ['ui', 'circle'] },
    ...
    { name: 'heart-filled', categories: ['ui'] },
    { name: 'info', categories: ['ui', 'circle'] },
    ...
    { name: 'keyhole', categories: ['ui', 'circle'] },
    ...
    { name: 'password-alt', categories: ['ui'] },
    ...
    { name: 'record', categories: ['multimedia', 'circle'] },
    ...
    { name: 'unavailable', categories: ['ui', 'circle'] },
    { name: 'unblock', categories: ['ui', 'circle'] },
...
exports.icons = [...exports.iconsCustom, ...exports.iconsPack].sort((0, helpers_1.sortByLocaleCompare)('name'));
exports.inputTypes = [
    'color',
    'date',
    'email',
...
exports.sizes = ['sm', 'md', 'lg'];
exports.textSizes = ['small', 'mid', 'regular', 'large'];
